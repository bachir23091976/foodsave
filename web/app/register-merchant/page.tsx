  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("http://localhost:4000/auth/register", {
        ...
        body: JSON.stringify({ email, password, firstName, lastName, role: "MERCHANT" }),
      });
      ...
      setToken(data.token);
      setMessage("Compte commerçant créé ! Vous pouvez maintenant créer votre profil de commerce.");
    } catch {
